    ...
    <div className="relative mb-10 ">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center h-full px-4 md:px-6 lg:px-10 animate__animated animate__backInLeft">
          <div className="w-full mt-[-4vh] md:w-1/2 sm:mt-0 md:mt-18 text-center md:text-left 3xl:mt-[-12vh] px-4 md:px-6">
            <h1 className="text-white text-lg md:text-xl lg:text-2xl xl:text-3xl 3xl:text-6xl font-semibold md:font-bold leading-tight mt-[30vh] md:mt-32 lg:mt-40">
              Transform Your Brand's Story: Embrace the Power of Digital Marketing
            </h1>
            <p className="text-white text-sm md:text-sm lg:text-lg 3xl:text-4xl 3xl:mt-14 mt-4 mb-6 md:mb-8">
            ...
            <button className="mt-4 text-sm md:text-base px-4 md:px-6 py-2 md:py-3 bg-teal-800 3xl:text-4xl text-white font-semibold rounded-lg hover:bg-cyan-700 transition duration-300 ease-in-out">
